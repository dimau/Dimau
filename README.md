...
Implementation adaptive and cross-browser **HTML/CSS markup** using **Sass/SCSS** preprocessor, **PostCSS** postprocessor, **semantic HTML** tags to increase accessibility, as well as adding dynamics to the UI with **CSS animations**, building projects with **Webpack**
